describe("JanusWeb Render textures", function() {
  ...
  it("loads a solid red texture", function(done) {
    var roomsrc = '<FireBoxRoom><Assets></Assets><Room skybox_left_id="black" skybox_right_id="black" skybox_top_id="black" skybox_bottom_id="black" skybox_front_id="black" skybox_back_id="black"><Image id="solid_red_png" pos="0 1 2" scale="5 5 5" lighting="false" /></Room></FireBoxRoom>';
  ...
  it("loads a solid green texture", function(done) {
    var roomsrc = '<FireBoxRoom><Assets></Assets><Room skybox_left_id="black" skybox_right_id="black" skybox_top_id="black" skybox_bottom_id="black" skybox_front_id="black" skybox_back_id="black"><Image id="solid_green_png" pos="0 1 2" scale="5 5 5" lighting="false" /></Room></FireBoxRoom>';
